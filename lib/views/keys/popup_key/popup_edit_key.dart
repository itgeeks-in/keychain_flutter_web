          ...
          children: [
            ...
            Container(
                ...
                decoration: new BoxDecoration(
                  border:
                      Border.all(color: ColorConsts.primaryColor, width: 1.0),
                          ...
                          builder: (context, state) {
                            if (state is CategoryLoadState) {
                              return Center(
                                child: Text("Loading Please wait...",
                                    style: ThemeText.textSmallPrimary),
                              );
                            }
                            ...
                            if (state is CategorySuccessState) {
                              if (state.data.length == 0) {
                                return Center(
                                  child: Text("Not found any category",
                                      style: ThemeText.textSmallPrimary),
                                );
                              }
                            ...
                            return SizedBox(
                                ...
                                child: DropdownButton<CategoryData>(
                                    ...
                                    return DropdownMenuItem<CategoryData>(
                                      ...
                                      child: Text(
                                        ...
                                        style: (item.categoryId ==
                                                widget.keysData.categoryId)
                                            ? ThemeText.textMediumSecondaryBold
                                  ...
                                  onChanged: (CategoryData? newValue) {
                                    context
                                        .read<CategoryPageBloc>()
                                        .selectOptionCategory = newValue;
                                    categoryIdSelect = context
                                        .read<CategoryPageBloc>()
                                        .selectOptionCategory!
                                        .categoryId;
                                    setState(() {});
            ...
            Center(
              ...
              if (_descriptionNameController.text.trim().isNotEmpty &&
            ...
            Center(
                child:
                    Text(error, style: TextStyle(color: ColorConsts.redColor))),
          ],
        ),
      ),
    ));
